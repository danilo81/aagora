    ...
    <div className="absolute top-4 right-4 bottom-4 w-96 bg-[#0a0a0a]/95 backdrop-blur-md border border-zinc-800 rounded-xl text-zinc-100 flex flex-col overflow-hidden shadow-2xl z-20 pointer-events-auto">
      <div className="p-4 border-b border-zinc-800 flex items-center justify-between bg-zinc-900/50">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-semibold tracking-tight uppercase text-sm">CÃ³mputos 5D</h2>
        </div>
        <button
          onClick={onClose}
      ...
      <div className="p-4 border-b border-zinc-800 flex flex-col gap-3">
        <p className="text-[10px] uppercase text-zinc-400 font-bold tracking-widest leading-relaxed">
          Seleccione una partida de la lista para activarla. Luego, haga clic en los elementos del modelo 3D para asignar sus cantidades (Volumen/Ãrea) automÃ¡ticamente a la partida seleccionada.
        </p>
        <input
          type="text"
          value={searchTerm}
          onChange={(e) => setSearchTerm(e.target.value)}
          placeholder="Buscar partida o capÃ­tulo..."
