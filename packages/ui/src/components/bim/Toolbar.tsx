...
interface ToolbarProps {
  ...
  setLineConfig?: (config: unknown) => void;
  rectangleConfig?: {
    fillColor: string;
    lineColor: string;
    opacity: number;
  ...
  return (
    <div className="absolute top-0 left-0 w-full h-full pointer-events-none z-10">
          ...
          <div className="flex items-center gap-1 border-r border-zinc-700 pr-2 mr-1">
            ...
            {selectedGroupId && !editingGroupId && (
              <ToolButton
                ...
                label="Edit Group"
                onClick={() => selectedGroupId && onEnterGroupEdit?.(selectedGroupId)}
              />
            )}
          </div>
      ...
      <div className={cn(
        ...
        {/* Render Mode Toggle */}
        <div className="bg-zinc-900/90 backdrop-blur-md border border-zinc-800 rounded-lg p-1 shadow-lg flex gap-1 mt-2 justify-center">
          <ToolButton
