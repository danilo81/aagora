...
export function AiChatModal() {
    ...
    const [messages, setMessages] = useState([
        { role: 'ai', content: '¡Hola! Soy agorabot AI. ¿En qué te puedo ayudar con tus proyectos hoy?' }
    ]);
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="max-w-[400px] h-[80vh] flex flex-col p-0 bg-card border-accent gap-0 shadow-2xl rounded-2xl overflow-hidden">
