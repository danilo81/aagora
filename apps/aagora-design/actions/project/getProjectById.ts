...
import { db, project, projectConfig, level, projectItem, projectContact, siteLog, projectTransaction, projectChangeOrder } from '@workspace/db';
...
export async function getProjectById(id: string) {
    ...
    try {
        ...
        // Project items with their construction item
