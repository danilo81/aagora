...
export type UserRole = "admin" | "editor" | "viewer" | "administrador" | "proveedor";
...
export interface BimElement {
    ...
    geometry: {
        ...
        args: [number, number, number] | [number, number, number, number] | [number, number, number, number, number, number] | number[] | unknown;
