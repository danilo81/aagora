...
export default function DashboardPage() {
    ...
    const loadBalances = async () => {
        ...
        try {
            ...
            setProjectBalances(balances.filter((b: { status?: string }) => b.status === 'activo' || b.status === 'construccion'));
        ...
        <div className="container mx-auto px-4 py-8 space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="relative" ref={menuRef}>
                        ...
                        {showConfigMenu && (
                            <div className="absolute right-0 mt-2 w-64 bg-card border border-accent/10 rounded-xl z-50 overflow-hidden">
                                <div className="p-3 border-b border-accent/10 bg-card flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 ">
                {widgetConfig.activeProjects && (
                    ...
                    <Link href="/projects" className="block">
                        <Card className="bg-card ring-primary/10 hover:border-accent transition-all cursor-pointer group relative overflow-hidden h-fit">
                ...
                {widgetConfig.balances && (
                    ...
                    <Card className="bg-card ring-primary/10 overflow-hidden p-0 lg:col-span-2 gap-0 ">
                        <CardHeader className="border-b ring-primary/10 bg-white/2 flex flex-row justify-between h-16 p-0 ">
                            <div>
                        ...
                        <ScrollArea className="h-[220px]">
                            <CardContent className="p-0">
                                {isError.balances ? (
                                    ...
                                    <ScrollArea className="w-full max-w-screen whitespace-nowrap border-b border-accent/20 ">
                                        <Table>
                                            ...
                                            <TableBody>
                                                {projectBalances.map((item, i) => (
                                                    <TableRow key={i} className="border-accent/20  transition-all tracking-widest w-full">
                                                        <TableCell className="px-6 py-4">
                                                            <div className="flex items-center gap-3">
                                                                <div className="p-1.5 bg-accent/20 rounded-lg border ">
                ...
                {/* WIDGET: ÓRDENES */}
                {widgetConfig.orders && (
                    <Card className="bg-card border-accent/20 overflow-hidden p-0 gap-0 ">
                        <CardHeader className="border-b border-accent/20 bg-white/2 flex flex-row  justify-between h-16 pt-6">
                            <div>
                        ...
                        <CardContent className="space-y-1 p-0">
                            {isError.orders ? (
                                ...
                                purchaseOrders.map((order, i) => (
                                    <div key={i} className="flex items-center justify-between p-5 border-b border-accent/20 transition-all last:border-0 m-0">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p className="text-[12px] font-bold text-primary uppercase tracking-tight">{order.id} — {order.supplier}</p>
                                                <div className="flex items-center gap-2 mt-1">
                                                    <Badge variant="outline" className="text-[12px] font-black uppercase h-4 px-1.5 border-accent/20 opacity-50">{order.label}</Badge>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 ">
                ...
                {widgetConfig.warehouse && (
                    <Card className="bg-card border-accent/20 overflow-hidden p-0 gap-0">
                        <CardHeader className="border-b border-accent/20 bg-card flex flex-row justify-between h-16 pt-6">
                            <div>
                                <CardTitle className="text-xs font-black uppercase tracking-widest flex items-center gap-2">
                            ...
                            {isError.warehouse ? (
                                ...
                                <div className="divide-y divide-white/5">
                                    {warehouseMovements.map((m, i) => (
                                        <div key={i} className="flex items-center justify-between p-5 transition-colors border-b border-accent/20">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    {m.notes && (
                                                        <p className="text-[10px] text-muted-foreground italic opacity-70 mt-1 line-clamp-1">
                                                            &quot;{m.notes}&quot;
                                                        </p>
                                                    )}
                                                </div>
                ...
                {/* WIDGET: LOGS */}
                {widgetConfig.logs && (
                    <Card className="bg-card ring-primary/10 overflow-hidden p-0 gap-0">
                        <CardHeader className="border-b ring-primary/10 bg-card flex flex-row  justify-between h-16 pt-6">
                            <div>
                                <CardTitle className="text-xs font-black uppercase tracking-widest flex items-center gap-2">
                        ...
                        <CardContent className="gap-0 p-0">
                            <div className="h-100 overflow-y-auto">
                                {isError.logs ? (
                                    ...
                                    <div className="p-0">
                                        {siteLogs.map((log, i) => (
                                            <div key={i} className="flex gap-4 p-5 hover:bg-white/2 border-b border-accent/20 last:border-0 transition-colors group">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                {widgetConfig.contacts && (
                    <Card className="bg-card ring-primary/10 overflow-hidden p-0 gap-0">
                        <CardHeader className="border-b ring-primary/10 bg-card flex flex-row justify-between h-16 pt-6 px-6">
                            <CardTitle className="text-xs font-black uppercase tracking-widest flex items-center gap-2">
                        ...
                        <CardContent className="p-0">
                            {isLoading.contacts ? (
                                ...
                                <div className="divide-y divide-white/5">
                                    {contacts.map((c, i) => (
                                        <div key={i} className="p-4 hover:bg-white/2 transition-colors flex items-center gap-3 border-b border-accent/20">
                    ...
                    <Card className="bg-card ring-primary/10 overflow-hidden p-0 gap-0">
                        ...
                        <CardContent className="p-0">
                            {isLoading.assets ? (
                                ...
                                <div className="divide-y divide-white/5">
                                    {assets.map((a, i) => (
                                        <div key={i} className="p-4 hover:bg-white/2 transition-colors space-y-2 border-b border-accent/20">
                                            <div className="flex justify-between items-start">
                            ...
                            {isLoading.inspections ? (
                                ...
                                <div className="divide-y divide-white/5">
                                    {inspections.map((ins, i) => (
                                        <div key={i} className="p-4 hover:bg-white/2 transition-colors space-y-1 border-b border-accent/20">
                                            <div className="flex justify-between items-start">
                            ...
                            {isLoading.supplyUpdates ? (
                                ...
                                <div className="divide-y divide-white/5">
                                    {supplyUpdates.map((up, i) => (
                                        <div key={i} className="p-4 hover:bg-white/2 transition-colors border-b border-accent/20">
                                            <div className="flex justify-between items-start">
