...
// Community app loads avatar placeholders from external image services.
const communityImgHosts = 'https://i.pravatar.cc https://picsum.photos https://images.unsplash.com';

const csp = [
  "default-src 'self'",
  `script-src 'self' 'unsafe-inline' ${clerkHosts}`,
  "style-src 'self' 'unsafe-inline'",
  `img-src 'self' data: blob: https://img.clerk.com https://images.clerk.dev ${r2Hosts} ${communityImgHosts}`,
  "font-src 'self' data:",
