...
import { SettingsModal } from '@workspace/ui/components/bim/SettingsModal';
import { SelectSimilarModal } from '@workspace/ui/components/bim/SelectSimilarModal';
import { ContextMenu } from '@workspace/ui/components/bim/ContextMenu';
import { BimElement, BimClass, WallType, LineType, Level, ScaleSettings, ArcConfig, SlabType, IssueNote, SavedView } from '@/types/types';
import { LevelSettingsModal } from '@workspace/ui/components/bim/LevelSettingsModal';
import { ScaleSettingsModal } from '@workspace/ui/components/bim/ScaleSettingsModal';
import { IfcCloudModal } from '@workspace/ui/components/bim/IfcCloudModal';
...
import { Box, Layers, Play, Loader2 } from 'lucide-react';
...
export default function ProjectDesignPage() {
    ...
    const [renderMode, setRenderMode] = useState<'solid' | 'wireframe' | 'xray' | 'material'>('material');
